...
if(isset($_POST['rgrbtn'])){
  ...
  //  $user_name=testfunc($user_name);
   ...
   // $email=testfunc($email);
    ...
    $result=mysqli_query($con,$query);
    $err = "Account Created Successfully! Please Check Your Email For The Activation Link :)";
    if(!$result){
  ...
  <div class="form">
        ...
        <form class="login-form" action="index.php" method="post">
         ...
         <input type="password" id="Password" name="Password" placeholder="Password" required>
          <p class= "<?php if($err != "" && $err !="Account Created Successfully! Please Check Your Email For The Activation Link :)" ) {echo 'alert-danger h6 py-2 mb-2 rounded-sm';} elseif($err == "Account Created Successfully! Please Check Your Email For The Activation Link :)") {echo 'alert-success h6 py-2 mb-2 rounded-sm';}?>"><?php if($err != "") {echo $err;} ?></p>
         <button type="submit" class="btn btn-success mt-0" id="loginbtn" name="loginbtn">Login</button>
         
         <!--  Forgot password modal href -->
         <p class="mt-3">
             <a href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#myModal1" class="text-danger"> Forgot Password?</a>
         </p>
        
        
         <p class="message text-white">Not Registered ? <a href="#"><br>Click Here To Register !</a></p>
        ...
        <button type="button" class="btn btn-secondary my-3" onclick="location.href='guest.php';" style="background-color:grey;">
          Enter as Guest
        </button>
